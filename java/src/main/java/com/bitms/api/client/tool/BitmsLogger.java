...
public class BitmsLogger
{
    ...
    {
        BitmsLogger.needEnableLogger = needEnableLogger;
    }
    ...
    public static void logBizDebug(String rsp)
    {
        ...
        df.setTimeZone(TimeZone.getTimeZone(BitmsConstants.DATE_TIMEZONE));
        StringBuilder sb = new StringBuilder();
    ...
    public static void logErrorScene(Map<String, Object> rt, BitmsResponse tRsp, String appSecret)
    {
        ...
        appendLog((BitmsMap) rt.get("protocalMustParams"), sb);
        sb.append("^_^");
        sb.append("ProtocalOptParams:");
        appendLog((BitmsMap) rt.get("protocalOptParams"), sb);
        sb.append("^_^");
        sb.append("ApplicationParams:");
        appendLog((BitmsMap) rt.get("textParams"), sb);
        sb.append("^_^");
        sb.append("Body:");
    ...
    private static void appendLog(BitmsMap map, StringBuilder sb)
    {
        boolean first = true;
