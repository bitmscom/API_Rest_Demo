...
{
    private static final String     DEFAULT_CHARSET = BitmsConstants.CHARSET_UTF8;
    ...
    public static String doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout) throws IOException
    {
        ...
        try
        {
            ...
            catch (IOException e)
            {
                ...
                BitmsLogger.logCommError(e, url, map.get("app_key"), map.get("method"), content);
                throw e;
            }
            try
            {
            ...
            {
                Map<String, String> map = getParamsFromUrl(url);
                BitmsLogger.logCommError(e, conn, map.get("app_key"), map.get("method"), content);
                throw e;
            }
        }
        finally
    ...
    public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset, int connectTimeout, int readTimeout)
            throws IOException
    {
        if (fileParams == null || fileParams.isEmpty()) { return doPost(url, params, charset, connectTimeout, readTimeout); }
        ...
        try
        {
            ...
            {
                Map<String, String> map = getParamsFromUrl(url);
                BitmsLogger.logCommError(e, url, map.get("app_key"), map.get("method"), params);
                throw e;
            }
            try
            {
            ...
            {
                Map<String, String> map = getParamsFromUrl(url);
                BitmsLogger.logCommError(e, conn, map.get("app_key"), map.get("method"), params);
                throw e;
            }
        }
        finally
    ...
    public String buildForm(String baseUrl, RequestHolder requestHolder)
    {
        return null;
    }
